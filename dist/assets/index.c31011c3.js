(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const e of a)if(e.type==="childList")for(const o of e.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function h(a){const e={};return a.integrity&&(e.integrity=a.integrity),a.referrerpolicy&&(e.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?e.credentials="include":a.crossorigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function n(a){if(a.ep)return;a.ep=!0;const e=h(a);fetch(a.href,e)}})();const r=document.querySelector("#inputID"),c=document.querySelector("#inputSenha"),l=document.querySelector(".status"),g=document.querySelector(".button-validate"),v=document.querySelector(".playerMusic"),t=document.querySelector(".showMusic"),d=document.querySelector(".showMusic img"),m=[`<div class="goal">
